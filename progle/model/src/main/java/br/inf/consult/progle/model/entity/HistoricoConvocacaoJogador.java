...
@Entity
@Table(name = "tb_historicos_contratacoes_jogadores")
@Data
@EqualsAndHashCode(callSuper = true)

public class HistoricoConvocacaoJogador extends GenericEntity<Long> {
    ...
    @OrderColumn(name = "posicao_order") // Adiciona a coluna de ordem
