...
public class FacesConfig implements ServletContextInitializer {
  ...
  public void onStartup(final ServletContext container) throws ServletException {
    ...
    container.setInitParameter("com.ocpsoft.pretty.BASE_PACKAGES", "br.inf.consult.progle");
    ...
    container.setInitParameter("javax.faces.FACELETS_LIBRARIES", "/WEB-INF/custom.taglib.xml");
    container.setInitParameter("primefaces.THEME", "none");
    container.setInitParameter("primefaces.FONT_AWESOME", "true");
    container.setInitParameter("javax.faces.STATE_SAVING_METHOD", "server");
